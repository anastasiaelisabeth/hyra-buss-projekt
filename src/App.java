...
public class App {
    ...
    public static void main(String[] args, String[] personNamn) throws Exception {
       // double prisVuxen = 299.90;
        ...
        while(alternativ!=4){
            switch (alternativ) {
                case 1:
                    födelsedatum = bokaPlats(födelsedatum, personNamn);
                    break;
                case 2:
    ...
    public static int[] bokaPlats(int[] födelsedatum, String[] personNamn){
